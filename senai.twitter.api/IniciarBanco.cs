...
namespace senai.twitter.api
{
    public class IniciarBanco
    {
        public static void Inicializar(BikeMobiContext _context)
        {
            ...
            var rotaPesquisada = new RotaPesquisa(1, 3, "10 mins", "R. Bom Pastor - Ipiranga, São Paulo - SP, Brazil", -23.5901388, -46.607101, "R. do Capitarizinho - Vila Liviero, São Paulo - SP, Brazil", -23.6479125, -46.596678, "lvioCf|k{GVw@");
            
            _context.Logins.Add(login);
            _context.Perfis.Add(perfil);
            _context.RotasPesquisas.Add(rotaPesquisada);
