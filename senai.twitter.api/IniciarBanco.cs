...
namespace senai.twitter.api
{
    public class IniciarBanco
    {
        public static void Inicializar(BikeMobiContext _context)
        {
            ...
            var rotaPesquisada = new RotaPesquisa(3, "10 mins", "R. Bom Pastor - Ipiranga, São Paulo - SP, Brazil", -23.5901388, -46.607101, "R. do Capitarizinho - Vila Liviero, São Paulo - SP, Brazil", -23.6479125, -46.596678, "lvioCf|k{GVw@");
            login.Perfil = perfil;
            login.RotasPesquisas.Add(rotaPesquisada);
